...
//   }, [watch('pincode'), setValue]);
  ...
  return (
    <div className={`fixed inset-0 bg-stone-800/60 flex justify-center items-center z-50 transition-opacity duration-300 ${isOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
      <div className={`bg-white p-8 rounded-md shadow-xl w-full max-w-2xl max-h-[90vh] transform transition-all duration-500 ease-out origin-center ${isOpen ? 'scale-100' : 'scale-80'}` }>
