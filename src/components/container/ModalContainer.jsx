...
function ModalContainer({children, isOpen, className = ''}) {
  ...
  return (
    <div className={`fixed inset-0 bg-stone-800/40 flex justify-center overflow-y-auto items-center z-50 transition-opacity m-0 duration-300 ${isOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
