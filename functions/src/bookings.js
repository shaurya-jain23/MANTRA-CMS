...
export const approveAndSyncBooking = https.onCall(
  ...
  async (request) => {
    ...
    try {
      ...
      const destination =
        booking.placeOfDelivery.toUpperCase() ||
        (booking.district ? booking.district.toUpperCase() : 'N/A');
...
export const deleteAndSyncBooking = https.onCall(
  { secrets: [googleServiceAccountKey] },
  async (request) => {
